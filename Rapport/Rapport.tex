...
Les résultats présentés plus tard dans la figure~\ref{fig:degree_convergence_full} tenteront d'illustrer l'impact du choix de la base de régression sur la précision de l'estimation,
par rapport au prix RK4 de référence. Nous veillerons à mettre cette dynamique en perspective avec la Figure~\ref{fig:basis_comparison} (issue de \cite{Benguigui}).
